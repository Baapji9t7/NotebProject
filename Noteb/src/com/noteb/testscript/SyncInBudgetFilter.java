...
public class SyncInBudgetFilter extends BaseClass {
	...
	public void VerifySyncInBudgetFilter() throws InterruptedException {
      ...
      // move the min slider in positive axis:
         ...
         String minSlider1 = home.getMinSlider().getAttribute("aria-valuemax");
         double minExpecValue5 = Double.parseDouble(minSlider1);
         System.out.println(minExpecValue5); 
         double minActValue5=1210.0;
      ...
      //move the min slider in negative axis: 
         ...
         String minSlider2 = home.getMinSlider().getAttribute("aria-valuemax");
         double minExpecValue7 = Double.parseDouble(minSlider2);
         System.out.println(minExpecValue7);
         double minActValue7=1210.0;
       ...
       //move the max slider in positive axis:
         ...
         String maxSlider2 = home.getMaxSlider().getAttribute("aria-valuemin");
         double maxExpecValue7 = Double.parseDouble(maxSlider2);
         System.out.println(maxExpecValue7);
         double maxActValue7=110.0;
     ...
     // move the max slider in negative axis:
        ...
        String maxSlider1 = home.getMaxSlider().getAttribute("aria-valuemin");
        double maxExpecValue6 = Double.parseDouble(maxSlider1);
        System.out.println(maxExpecValue6);  
        double maxActValue6=110.0;
        ...
        String min1=home.getMinSlider().getAttribute("aria-valuemax");
        double minExpecValue3 = Double.parseDouble(min1);
        String max1=home.getMaxSlider().getAttribute("aria-valuemin");
        ...
        String min2=home.getMinSlider().getAttribute("aria-valuemax");
        double minExpecValue4 = Double.parseDouble(min2);
        String max2=home.getMaxSlider().getAttribute("aria-valuemin");
